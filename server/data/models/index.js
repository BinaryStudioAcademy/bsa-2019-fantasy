...
const PlayerStat = orm.import('./player_stat');
const PlayerMatchStat = orm.import('./player_match_stat');
const League = orm.import('./league');
const LeagueParticipant = orm.import('./league_participant');
const Gameweek = orm.import('./gameweek');
const GameweekHistory = orm.import('./gameweek_history');
const Game = orm.import('./game');
const FootballClub = orm.import('./football_club');
